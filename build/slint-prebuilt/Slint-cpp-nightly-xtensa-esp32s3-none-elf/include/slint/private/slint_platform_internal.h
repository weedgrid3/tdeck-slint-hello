...
void slint_context_accent_color(const ItemTreeRc *root, Color *out);

ColorScheme slint_context_color_scheme(const ItemTreeRc *root);
...
void slint_macos_bring_all_windows_to_front();

void slint_string_to_styled_text(const SharedString *text, StyledText *out);

void slint_color_to_styled_text(const Color *color, StyledText *out);
