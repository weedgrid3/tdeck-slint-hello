...
struct ItemTreeVTable {
    ...
    bool (*ensure_instantiated)(Pin<VRef<ItemTreeVTable>>);
...
struct SystemTrayIconDataBox {
struct SystemTrayIconData;
    SystemTrayIconData *_0;
};

struct SystemTrayIcon {
    Property<Image> icon;
    Property<SharedString> tooltip;
    Property<SharedString> title;
    Property<bool> visible;
    Property<ColorScheme> color_scheme;
    private_api::CallbackHelper<void> clicked;
    CachedRenderingData cached_rendering_data;
    SystemTrayIconDataBox data;
    inline SystemTrayIcon(); inline ~SystemTrayIcon();
};
...
struct DragArea {
    ...
    Property<Image> drag_image;
    Property<int32_t> drag_image_offset_x;
    Property<int32_t> drag_image_offset_y;
    Property<bool> allow_copy;
    Property<bool> allow_move;
    Property<bool> allow_link;
    Property<bool> dragging;
    private_api::CallbackHelper<DragAction> drag_finished;
    bool pressed;
...
struct DropArea {
    Property<bool> enabled;
    Property<bool> has_drag;
    Property<DragAction> current_action;
    private_api::CallbackHelper<DropEvent, DragAction> can_drop;
    private_api::CallbackHelper<DropEvent, DragAction> dropped;
    CachedRenderingData cached_rendering_data;
};
...
struct TooltipArea {
    ...
    Property<LogicalLength> offset;
    private_api::CallbackHelper<void> show;
    private_api::CallbackHelper<void> hide;
    CachedRenderingData cached_rendering_data;
    bool popup_visible;
    Timer timer;
};
...
bool slint_windowitem_close(Pin<const WindowItem*> window_item,
...
void slint_textinput_undo(Pin<const TextInput*> text_input,
                          const WindowAdapterRcOpaque *window_adapter,
                          const VRc<ItemTreeVTable> *self_component,
                          uint32_t self_index);

void slint_textinput_redo(Pin<const TextInput*> text_input,
                          const WindowAdapterRcOpaque *window_adapter,
                          const VRc<ItemTreeVTable> *self_component,
                          uint32_t self_index);
...
void slint_system_tray_icon_data_init(SystemTrayIconDataBox *data);

/// # Safety
/// This must be called using a non-null pointer pointing to an initialized SystemTrayIconDataBox
void slint_system_tray_icon_data_free(SystemTrayIconDataBox *data);

void slint_system_tray_icon_set_menu(const SystemTrayIcon *system_tray,
                                     const ItemRc *item_rc,
                                     const VRc<MenuVTable> *menu_vrc);
...
void slint_solve_box_layout_ortho(const BoxLayoutOrthoData *data,
                                  Slice<uint32_t> repeater_indices,
                                  SharedVector<float> *result);
...
float slint_flexbox_layout_unwrapped_main(Slice<FlexboxLayoutItemInfo> cells,
                                          float spacing,
                                          const Padding *padding);
...
void slint_menus_create_wrapper(const ItemTreeRc *menu_tree,
                                ...
                                bool (*visible)(const ItemTreeRc *menu_tree));

void slint_repeater_ensure_updated(RepeaterInstanceOpsVTable *ops,
                                   uintptr_t offset,
                                   uintptr_t count);

bool slint_repeater_ensure_updated_listview(RepeaterInstanceOpsVTable *ops,
...
/// The resulting structure must be passed to slint_shared_string_drop
void slint_shared_string_from_number_unlocalized(SharedString *out, double n);
...
void slint_styled_text_from_plain_text(Slice<uint8_t> text, StyledText *out);

/// Parse markdown into styled text. Returns true on success.
/// On failure, resets `out` to default.
bool slint_styled_text_from_markdown(Slice<uint8_t> markdown, StyledText *out);
...
void slint_decimal_separator(SharedString *out);
...
void slint_windowrc_ensure_tree_instantiated(const WindowAdapterRcOpaque *handle);
...
uint32_t slint_windowrc_show_popup(const WindowAdapterRcOpaque *handle,
                                   ...
                                   void (*position)(void *user_data, LogicalPosition *pos),
                                   void (*drop_user_data)(void *user_data),
                                   void *user_data,
                                   PopupClosePolicy close_policy,
                                   const ItemRc *parent_item,
                                   WindowKind window_kind,
                                   void (*is_open_setter)(void *user_data, bool is_open),
                                   void (*is_open_setter_drop_user_data)(void *user_data),
                                   void *is_open_setter_user_data);
...
bool slint_windowrc_create_child_window_adapter(const WindowAdapterRcOpaque *handle,
                                                WindowKind window_kind,
                                                WindowAdapterRcOpaque *result);
...
SLINT_DECL_ITEM(SystemTrayIcon);
}
