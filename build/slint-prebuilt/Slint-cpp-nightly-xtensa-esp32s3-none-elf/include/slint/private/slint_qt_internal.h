...
using Qt_WindowType = unsigned int;
...
using Qt_DropAction = unsigned int;
...
constexpr static const Qt_WindowType Qt_WindowType_Widget = 0;

constexpr static const Qt_WindowType Qt_WindowType_Window = 1;

constexpr static const Qt_WindowType Qt_WindowType_Dialog = 3;

constexpr static const Qt_WindowType Qt_WindowType_Sheet = 5;

constexpr static const Qt_WindowType Qt_WindowType_Drawer = 7;

constexpr static const Qt_WindowType Qt_WindowType_Popup = 9;

constexpr static const Qt_WindowType Qt_WindowType_Tool = 11;

constexpr static const Qt_WindowType Qt_WindowType_ToolTip = 13;

constexpr static const Qt_WindowType Qt_WindowType_SplashScreen = 15;

constexpr static const Qt_WindowType Qt_WindowType_Desktop = 17;

constexpr static const Qt_WindowType Qt_WindowType_SubWindow = 18;

constexpr static const Qt_WindowType Qt_WindowType_ForeignWindow = 33;

constexpr static const Qt_WindowType Qt_WindowType_CoverWindow = 65;

constexpr static const Qt_WindowType Qt_WindowType_WindowType_Mask = 255;

constexpr static const Qt_WindowType Qt_WindowType_MSWindowsFixedSizeDialogHint = 256;

constexpr static const Qt_WindowType Qt_WindowType_MSWindowsOwnDC = 512;

constexpr static const Qt_WindowType Qt_WindowType_BypassWindowManagerHint = 1024;

constexpr static const Qt_WindowType Qt_WindowType_X11BypassWindowManagerHint = 1024;

constexpr static const Qt_WindowType Qt_WindowType_FramelessWindowHint = 2048;

constexpr static const Qt_WindowType Qt_WindowType_WindowTitleHint = 4096;

constexpr static const Qt_WindowType Qt_WindowType_WindowSystemMenuHint = 8192;

constexpr static const Qt_WindowType Qt_WindowType_WindowMinimizeButtonHint = 16384;

constexpr static const Qt_WindowType Qt_WindowType_WindowMaximizeButtonHint = 32768;

constexpr static const Qt_WindowType Qt_WindowType_WindowMinMaxButtonsHint = 49152;

constexpr static const Qt_WindowType Qt_WindowType_WindowContextHelpButtonHint = 65536;

constexpr static const Qt_WindowType Qt_WindowType_WindowShadeButtonHint = 131072;

constexpr static const Qt_WindowType Qt_WindowType_WindowStaysOnTopHint = 262144;

constexpr static const Qt_WindowType Qt_WindowType_WindowTransparentForInput = 524288;

constexpr static const Qt_WindowType Qt_WindowType_WindowOverridesSystemGestures = 1048576;

constexpr static const Qt_WindowType Qt_WindowType_WindowDoesNotAcceptFocus = 2097152;

constexpr static const Qt_WindowType Qt_WindowType_MaximizeUsingFullscreenGeometryHint = 4194304;

constexpr static const Qt_WindowType Qt_WindowType_ExpandedClientAreaHint = 4194304;

constexpr static const Qt_WindowType Qt_WindowType_NoTitleBarBackgroundHint = 8388608;

constexpr static const Qt_WindowType Qt_WindowType_CustomizeWindowHint = 33554432;

constexpr static const Qt_WindowType Qt_WindowType_WindowStaysOnBottomHint = 67108864;

constexpr static const Qt_WindowType Qt_WindowType_WindowCloseButtonHint = 134217728;

constexpr static const Qt_WindowType Qt_WindowType_MacWindowToolBarButtonHint = 268435456;

constexpr static const Qt_WindowType Qt_WindowType_BypassGraphicsProxyWidget = 536870912;

constexpr static const Qt_WindowType Qt_WindowType_NoDropShadowWindowHint = 1073741824;

constexpr static const Qt_WindowType Qt_WindowType_WindowFullscreenButtonHint = 2147483648;
...
constexpr static const Qt_DropAction Qt_DropAction_CopyAction = 1;

constexpr static const Qt_DropAction Qt_DropAction_MoveAction = 2;

constexpr static const Qt_DropAction Qt_DropAction_LinkAction = 4;

constexpr static const Qt_DropAction Qt_DropAction_ActionMask = 255;

constexpr static const Qt_DropAction Qt_DropAction_TargetMoveAction = 32770;

constexpr static const Qt_DropAction Qt_DropAction_IgnoreAction = 0;
