...
function(_slint_download_compiler_and_cache)
    set(SLINT_GITHUB_RELEASE "v1.18.0" CACHE STRING "GitHub Release to use for Slint Binary Artifact Downloads")
...
set(SLINT_COMPILER download CACHE STRING "Path to the slint-compiler executable")
if (SLINT_COMPILER)
...
elseif (ON)
    add_executable(Slint::slint-compiler IMPORTED GLOBAL)
    set_target_properties(Slint::slint-compiler PROPERTIES IMPORTED_LOCATION "${_IMPORT_PREFIX}/bin/")
    include("${CMAKE_CURRENT_LIST_DIR}/SlintMacro.cmake")
endif()
